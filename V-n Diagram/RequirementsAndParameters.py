...
TO_length_max = 4500                    # Max takeoff field length [ft]
...
'      Aircraft Parameters     '
'-------------------------------'
WTO = 69984                             # Maximum takeoff weight [lbf]    
CL_max_TO = 2.4
...
W_fuel_initial = 11000                  # Initial fuel weight [lbf]
...
W_min = WTO - W_fuel_initial - (pass_bag_W*pass_num) - pass_bag_W_tot  # Minimum weight [lbf]
...
# CDO_cruise = 0.0297                 # Clean, cruise configuration
# CDO_TO_GU = 0.0447                  # Take-off flaps, gear up
# CDO_TO_GD = 0.0637                  # Take-off flaps, gear down
# CDO_L_GU = 0.0897                    # Landing flaps, gear up
