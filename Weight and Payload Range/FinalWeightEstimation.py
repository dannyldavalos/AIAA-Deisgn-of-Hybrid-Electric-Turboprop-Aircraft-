...
def Fuel_Fraction_Total(W0):
    ...
    P_max_takeoff = 19390 / num_eng           # engine max power @ sea level (shp)
    ...
    P_max = P_max_takeoff * N_engine             # [hp] 
...
while delta > err:
    ...
    W0_new = (12660) / (1 - Wf_W0 - We_W0 - Wb_W0)      # lbf, compute new TOGW
...
MRW = round(W0_history[-1])

print(f'MRW (W0): {MRW} lbf')
